# OpenHouse API Endpoint Information

## Request OpenHouse Information for a List of OpenHouses

Returns a list of OpenHouses of the MLS from the UNLOCK MLS based on the filter parameters included in the request.

## Example Code

### Example URL Request
```markdown
https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/OpenHouse?access_token={access_token}
```
### Example Response
```json
{
@odata.context: "https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/$metadata#OpenHouse",
@odata.nextLink: "https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/",
value: [
{
@odata.context: "https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/$metadata#OpenHouse",
@odata.id: "https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/OpenHouse({OpenHouseKey})",
OpenHouseKey: "{OpenHouseKey}",
OpenHouseDate: "2019-04-29T23:40:46.861Z",
OpenHouseStartTime: "2019-04-30T05:40:46.861Z",
OpenHouseEndTime: "2019-04-30T05:40:46.861Z",
OpenHouseType: [
"Public",
"Broker"
],
OpenHouseRemarks: "Et quis tenetur nesciunt eveniet laboriosam.",
ModificationTimestamp: "2017-07-04T01:26:39.781Z",
OriginalEntryTimestamp: "2017-12-29T21:23:47.461Z",
AppointmentRequiredYN: true,
Refreshments: "Optio rerum doloribus nihil. Et illo enim ad veniam illum dolorem quasi velit.",
Attended: "Unattended",
Status: [
"Active"
],
...
OpenHouseId: null,
OpenHouseKeyNumeric: null,
OpenHouseStatus: null,
OriginatingSystemID: "{dataset_id}",
OriginatingSystemKey: "{dataset_id}",
OriginatingSystemName: "{dataset_id}",
ShowingAgentFirstName: "Edythe",
ShowingAgentKey: "{MemberKey}",
ShowingAgentKeyNumeric: null,
ShowingAgentLastName: "Stroman",
ShowingAgentMlsID: "MemberMlsId",
SourceSystemID: null,
...
## Request OpenHouse Information for a Single OpenHouse
Returns MLS information about a single OpenHouse from UNLOCK MLS.
## Example Code

### Example URL Request
```markdown
https://api.bridgedataoutput.com/api/v2/OData/{dataset_id}/OpenHouse({OpenHouseKey})?access_token={access_token}
```
### Example Response
The same response for a list of OpenHouse, except you will receive only data from a single OpenHouse
...
| `access_token` | string | Token to identify the user or application. |
| `dataset` | string | Dataset to get the listings from. |
| `OpenHouseKey` | string | Key to identify a OpenHouse |
| `$skip` | integer | Skip the first n items |
| `$select` | string | Select properties that are explicitly specified e.g. OfficeType |
| `$unselect` | string | Filter record properties that are explicitly specified e.g. OfficeFax |
| `$top` | integer | Show only the first n items |
